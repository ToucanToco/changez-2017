...
var QUESTIONS = [
  ...
  {id: 5, text:"Pensez-vous que les programmes politiques des candidats ou partis politiques : [correspondent aux attentes des Français ?]", type: "leaderboard", theme: "programme"},
  {id: 6, text:"Pensez-vous que les programmes politiques des candidats ou partis politiques : [permettraient d'améliorer la vie des Français ?]", type: "leaderboard", theme: "programme"},
  ...
  {id: 12, text:"Pensez-vous que nos présidents successifs ont su utiliser internet pour écouter l'opinion des Français ?", type: "leaderboard", theme: "internet"},
